...
## Step 7: the machine keeps its own diary (2026-08-14)

The unattended proof, twice over. First the mid-range: ran four minutes of
real degraded load (160 invocations, 21 deliberate errors) ending 06:56:31Z
and touched nothing else. The scheduled 06:58:06Z run found a 13.1 percent
real error rate, went to STRAIN, and wrote "my stuttering rhythm sparks and
seeks its beat". Then the top of the range: four minutes of incident load
(505 invocations, 177 real errors, plus the concurrency burst) ending
07:12:48Z. The scheduled 07:13:07Z run read 96 invocations per minute, a
36.5 percent error rate, concurrency pinned at the account cap of 10 and
eight real throttles, went to DANGER, and the primary model wrote "a heavy
gale sweeps through my bone, while rising waters press the stone". The
rising water is the throttles. Every mood on the panel has now been earned
by real conditions: RECOVERY, STRAIN and DANGER live from the schedule,
STABLE and SURGE and IDLE proven through the calibration replay.

Verified the live page in a browser during the DANGER window: red ALERT LED
pulsing, telemetry strip showing ERR 36.5%, THROTTLE 8, CONC 10, and the
